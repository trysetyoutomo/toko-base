...
<style type="text/css">
	...
	<br>
		<fieldset style="border:1px solid transparent;padding:20px;overflow:auto;">
			...
			<h1> <i class="fa fa-sign-in" aria-hidden="true"></i> Setor Tunai </h1>
			<hr>
			
			<div class="row">
				<label for="jumlah" >Tanggal Setor Tunai</label>
			...
			<div class="row">
				<label>Nominal Setor Tunai</label>
		...
		<div class="">
			<div class="" style="display:inline">
				...
				function kirim(){
					...
					if (total=="" || total==0){
						alert("Total Setor wajib di isi");
						return ;
					}
					...
					var head = {
						...
						pembayaran_via :pembayaran_via
						 ...
						 $.ajax({
							url: '<?php echo Yii::app()->createAbsoluteUrl('cashflow/setortunai'); ?>', 
							data: {
								// jsonObj :jsonObj,
								head :head
							},
