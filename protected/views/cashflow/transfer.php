...
<style type="text/css">
	...
	<br>
		<fieldset style="border:1px solid transparent;padding:20px;overflow:auto;">
			...
			<h1> <i class="fa fa-exchange" aria-hidden="true"></i> Transfer </h1>
			<hr>
			...
			<div class="row">
				<label for="jumlah" >Sumber</label>
				<select  style="width: 450px;display: inline"  id="sumber" class="form-control ">
                  <?php 
            ...
            <div class="row">
				...
				<select  style="width: 450px;display: inline"  id="tujuan" class="form-control ">
                  <?php 
					$criteria = new CDbCriteria;
					$criteria->select ='t.*';
					$criteria->condition =" store_id = '".Yii::app()->user->store_id()."' and group_id = 5 ";
				...
				function kirim(){
					...
					var head = {
						...
						tujuan :tujuan
						 ...
						 $.ajax({
							url: '<?php echo Yii::app()->createAbsoluteUrl('cashflow/transfer'); ?>', 
							data: {
								head :head
							},
