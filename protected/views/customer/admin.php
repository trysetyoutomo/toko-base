...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <li>
          ...
          <a href="<?php echo Yii::app()->createUrl("Customer/update", array("id"=>$value[id],"status"=>"ubah")) ?>">
            <i class="fa fa-pencil"></i> Ubah
          </a>
    </li>
     <li>
      
          <a href="<?php echo Yii::app()->createUrl("Customer/view", array("id"=>$value[id],"status"=>"ubah")) ?>">
            <i class="fa fa-eye"></i> Lihat
          </a>
    </li>
    <li>
        <a class="hapus" href="<?php echo Yii::app()->createUrl("Customer/hapus", array("id"=>$value[id])) ?>">
