		...
		<div class="col-sm-12">
			<div class="container mt-20">
				...
				<div class="row-group d-block">
					...
					<div class="row">
						<?php echo $form->labelEx($model, 'percent_tax', array('class' => "col-sm-2")); ?>
						<?php echo $form->textField($model, 'percent_tax', array('class' => 'col-sm-10 form-control', 'size' => 3, 'maxlength' => 3)); ?>
						<?php echo $form->error($model, 'percent_tax'); ?>
					</div>


					<div class="row">
						<?php echo $form->labelEx($model, 'percent_service', array('class' => "col-sm-2")); ?>
						<?php echo $form->textField($model, 'percent_service', array('class' => 'col-sm-10 form-control', 'size' => 3, 'maxlength' => 3)); ?>
						<?php echo $form->error($model, 'percent_service'); ?>
					</div>

					<div class="row">
						<?php echo $form->labelEx($model, 'instagram', array('class' => "col-sm-2")); ?>
						<?php echo $form->textField($model, 'instagram', array('class' => 'col-sm-10 form-control', 'size' => 3, 'maxlength' => 50)); ?>
