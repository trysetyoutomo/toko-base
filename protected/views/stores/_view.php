<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('receipt_header')); ?>:</b>
	<?php echo CHtml::encode($data->receipt_header); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('receipt_footer')); ?>:</b>
	<?php echo CHtml::encode($data->receipt_footer); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('nop')); ?>:</b>
	<?php echo CHtml::encode($data->nop); ?>
	<br />
