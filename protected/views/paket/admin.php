...
<h1>Mengelola Paket</h1>
<hr>
<div class="row">
	<div class="col-sm-8">
		<a href="<?php echo Yii::app()->createUrl("items/createpaket") ?>">
	...
	'columns'=>array(
		...
		*/
		...
		// ),
			...
			// 	),
			// 		// 'label'=> 'Update',
			// 		'url'=>'Yii::app()->createUrl("paket/view", array("id"=>$data[id_paket],"status"=>"ubah"))',      //A PHP expression for generating the URL of the button.
