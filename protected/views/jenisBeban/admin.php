<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="<?php echo Yii::app()->createUrl('JenisBeban/admin'); ?>">Mengelola Biaya</a></li>
</ol>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <li>
          ...
          <a href="<?php echo Yii::app()->createUrl("JenisBeban/update", array("id"=>$value[id],"status"=>"ubah")) ?>">
            <i class="fa fa-pencil"></i> Ubah
          </a>
    </li>
     <li>
      
          <a href="<?php echo Yii::app()->createUrl("JenisBeban/view", array("id"=>$value[id],"status"=>"ubah")) ?>">
            <i class="fa fa-eye"></i> Lihat
          </a>
    </li>
    <li>
        <a class="hapus" href="<?php echo Yii::app()->createUrl("JenisBeban/hapus", array("id"=>$value[id])) ?>">
    ...
    <!-- <li><a href="#">Separated link</a></li> -->
              ...
              <!-- <a href=""></a> -->
        		...
        		<td>
            <a href="<?php echo Yii::app()->createUrl("JenisBeban/update", array("id"=>$value[id])) ?>">
            <?php echo $value['nama'] ?>
            </a>
