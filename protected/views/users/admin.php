<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="<?php echo Yii::app()->createUrl('Users/admin'); ?>">Mengelola Pengguna</a></li>
</ol>
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu">
    ...
    <li>
          ...
          <a href="<?php echo Yii::app()->createUrl("Users/update", array("id"=>$value[id],"status"=>"ubah")) ?>">
            <i class="fa fa-pencil"></i> Ubah
          </a>
    </li>
     <li>
      
          <a href="<?php echo Yii::app()->createUrl("Users/view", array("id"=>$value[id],"status"=>"ubah")) ?>">
            <i class="fa fa-eye"></i> Lihat
          </a>
    </li>
    <li>
        <a class="hapus" href="<?php echo Yii::app()->createUrl("Users/hapus", array("id"=>$value[id])) ?>">
