...
class SalesItems extends CActiveRecord
{
	...
	// array("item_modal","required","on"=>'insert',"message"=>" Harga Modal belum di tentukan"),
			
			array('sale_id, item_tax, item_price, item_discount, item_total_cost', 'numerical', 'integerOnly'=>true),
